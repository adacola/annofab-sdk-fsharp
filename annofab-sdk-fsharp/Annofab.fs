...
module Annofab =
    ...
    type PutInputDataRequest = JsonProvider<"""{"input_data_name":"str","input_data_path":"str","input_data_type":"image","last_update_datetime":"date"}""">
    type PutInputDataResponse = JsonProvider<"""{"input_data_id":"str","project_id": "str","input_data_name":"str","input_data_path":"str","original_input_data_path":"str","scale":0,"input_data_type":"image","update_datetime":"date"}""">
    ...
    type GetInputsResponse = JsonProvider<"""{"list": [{"input_data_id":"str","project_id":"str","input_data_name":"str","input_data_path":"str","original_input_data_path":"str","scale":0,"input_data_type":"image","update_datetime": "date"}],"has_next":true}""">
    type GetTaskResponse = JsonProvider<"""{"project_id":"str","task_id":"str","phase": "annotation","status": "not_started","input_data_id_list": ["str"],"account_id":"str","account_id_history": ["str"],"work_timespan":0,"start_datetime":"date","update_datetime":"date"}""">
    type DeleteTaskResponse = JsonProvider<"""{"project_id":"str","task_id":"str","phase": "annotation","status": "not_started","input_data_id_list": ["str"],"account_id":"str","account_id_history": ["str"],"work_timespan": 0,"start_datetime":"date","update_datetime":"date"}""">
    type PutTaskRequest = JsonProvider<"""{"input_data_id_list":["str"]}""">
    type PutTaskResponse = JsonProvider<"""{"project_id":"str","task_id":"str","phase":"annotation","status":"not_started","input_data_id_list": ["str"],"account_id":"str","account_id_history": ["str"],"work_timespan": 0,"start_datetime":"date","update_datetime":"date"}""">
    ...
    type GetTasksResponse = JsonProvider<"""{"list":[{"project_id":"str","task_id":"str","phase":"str","status":"str","input_data_id_list":["str"],"account_id":"str","account_id_history":["str","str"],"work_timespan":"468872","start_datetime":"date","update_datetime":"date"}],"page_no":1,"total_page_no":10}""">
    ...
    type GetAnnotationResponse = JsonProvider<"""{"project_id":"str","task_id":"str","input_data_id":"str","detail":[],"comment":"str","update_datetime":"str"}""">
